...
namespace MTCG_Tests {
    public class TestCardWeaknesses {
        ...
        [Test]
        public void TestSpellBattleFire20VsGround20_ReturnsGround() {
	        //Arrange
	        ICard ground = new Spell(0, "Ground Spell", 20, ElementType.Ground);
	        ICard fire = new Spell(0, "Fire Spell", 20, ElementType.Fire);

	        // Act
	        ICard winner = _battle.SpellBattle(ground, fire);

	        // Assert
	        Assert.AreEqual(ground, winner);
        }

        [Test]
        public void TestSpellBattleFire20VsIce50_ReturnsFire() {
	        //Arrange
	        ICard ice = new Spell(0, "Ice Spell", 50, ElementType.Ice);
	        ICard fire = new Spell(0, "Fire Spell", 20, ElementType.Fire);

	        // Act
	        ICard winner = _battle.SpellBattle(ice, fire);
		...
		[Test]
        public void TestSpellBattleNormal20VsIce20_ReturnsIce() {
	        //Arrange
	        ICard normal = new Spell(0, "Normal Spell", 20, ElementType.Normal);
	        ICard ice = new Spell(0, "Ice Spell", 20, ElementType.Ice);

	        // Act
	        ICard winner = _battle.SpellBattle(normal, ice);

	        // Assert
	        Assert.AreEqual(ice, winner);
        }

        [Test]
        public void TestSpellBattleNormal20VsElectric50_ReturnsNormal() {
	        //Arrange
	        ICard normal = new Spell(0, "Normal Spell", 20, ElementType.Normal);
	        ICard electric = new Spell(0, "Electric Spell", 50, ElementType.Electric);

	        // Act
	        ICard winner = _battle.SpellBattle(normal, electric);
        ...
        [Test]
        public void TestSpellBattleWater20VsElectric20_ReturnsElectric() {
	        //Arrange
	        ICard water = new Spell(0, "Water Spell", 20, ElementType.Water);
	        ICard electric = new Spell(0, "Electric Spell", 20, ElementType.Electric);

	        // Act
	        ICard winner = _battle.SpellBattle(water, electric);

	        // Assert
	        Assert.AreEqual(electric, winner);
        }

        [Test]
        public void TestSpellBattleWater20VsGround50_ReturnsGround() {
	        //Arrange
	        ICard water = new Spell(0, "Water Spell", 20, ElementType.Water);
	        ICard ground = new Spell(0, "Ground Spell", 50, ElementType.Ground);

	        // Act
	        ICard winner = _battle.SpellBattle(water, ground);
